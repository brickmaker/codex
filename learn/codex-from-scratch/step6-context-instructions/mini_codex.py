...
class Agent:
    def __init__(self, model: RuleBasedModel, tools: ToolRegistry, context_manager: ContextManager) -> None:
        self.model = model
        self.tools = tools
...
def main() -> None:
    ...
    agent = Agent(RuleBasedModel(), ToolRegistry(config), ContextManager(config))
